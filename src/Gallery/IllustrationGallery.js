...
export default function IllustrationGallery() {
    ...
    useEffect(() => {
        document.body.style.backgroundColor = "var(--violeta-black, #000000)";
                    ...
                    {group.map((illustrationData, colIndex) => (
                        <div
                            ...
                            style={{
                                ...
                                borderRight: windowWidth > 767.98 ? (colIndex === 3 ? "none" : "1px solid var(--violeta-white, #FFF)") : (colIndex === 1 ? "none" : "1px solid var(--violeta-white, #FFF)"),
                                //if last row remove border bottom
                                borderBottom: rowIndex === groupedArray.length - 1 ? "none" : "1px solid var(--violeta-white, #FFF)"
                            }}
                        >
