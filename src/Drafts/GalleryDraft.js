...
import GalleryImage from "../Gallery/galleryComponents/GalleryImage";

export default function GalleryDraft(){
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            const filteredData = mergedData
                .filter(gallery => gallery.acf.display_in_sections.includes('draftGallery'))
                .map(gallery => ({
    ...
    return(
        <>
            ...
            <div className="container-fluid printShopContainer" style={{borderTop:"1px solid white"}}>
