...
export default function WorkPost(props) {
  ...
  const [initialWindowWidth, setInitialWindownWidth] = useState(
    window.innerWidth
  );
    ...
    <>
      ...
      <div className="d-sm-block d-md-none overflow-x-hidden">
        ...
        >
          ...
          <div className="text-start text-uppercase">{workData.event}</div>
          <div className="text-start text-uppercase">{workData.local}</div>
          <div
            className="text-start text-uppercase"
            style={{ paddingBottom: "1rem" }}
          >
      ...
      <div className="d-none d-md-block overflow-x-hidden">
        ...
        >
          ...
          <div
            className="col-7 text-start overflow-x-hidden"
            style={{
              paddingTop: "56px",
              paddingLeft: "1rem",
              paddingBottom: "56px",
